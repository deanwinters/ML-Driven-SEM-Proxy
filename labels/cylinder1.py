...
import numpy as np
from variables import scaling, px, centre, X_mm, Y_mm, cylinder1_radius, cylinder1_height
from plot import plot_surface

def construct_cylinder1(scaling,px,centre,cylinder1_radius,cylinder1_height):     
    #Empty heightmap
    ...
    for i in range(px):
        ...
        for j in range(px):
            ...
            #Inside radius:
            if distance_from_centre <= cylinder1_radius:
                heightmap[i,j] =  cylinder1_height
...
if __name__ == "__main__":
    ...
    heightmap = construct_cylinder1(scaling,px,centre,cylinder1_radius, cylinder1_height)
