import numpy as np
from variables import scaling, px, centre, X_mm, Y_mm, cutcylinder1_radius, cutcylinder1_height
from plot import plot_surface

def construct_cutcylinder1(scaling,px,centre,cutcylinder1_radius,cutcylinder1_height):     
    #Empty heightmap
    ...
    for i in range(px):
        ...
        for j in range(px):
            ...
            #Inside radius:
            if distance_from_centre <= cutcylinder1_radius and dx>=0:
                heightmap[i,j] =  cutcylinder1_height
...
if __name__ == "__main__":
    ...
    heightmap = construct_cutcylinder1(scaling,px,centre,cutcylinder1_radius, cutcylinder1_height)
