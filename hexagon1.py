import numpy as np
from variables import scaling, px, centre, X_mm, Y_mm,  hexagon1_base_radius, hexagon1_height, hexagon1_angle
from plot import plot_surface
from skimage.draw import polygon

def construct_hexagon1(scaling,px, centre, base_radius, prism_height, draft_angle):
...
if __name__ == "__main__":
    ...
    heightmap = construct_hexagon1(scaling,px, centre, hexagon1_base_radius, hexagon1_height, hexagon1_angle)
    plot_surface(X_mm, Y_mm, heightmap, "hexagon1", zlim=1)
